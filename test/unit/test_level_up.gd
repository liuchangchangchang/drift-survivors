...
func before_each():
	...
	# Don't add_child - we call methods directly to avoid autoload conflict
	# The autoload LevelUpManager also listens to EventBus.xp_gained
